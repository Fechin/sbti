...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the self-contained SBTI test skill.")
...
def main() -> int:
    ...
    try:
        ...
        print("sbti skill: aborted by user.", file=sys.stderr)
        return 1
    except Exception as error:
        print(f"sbti skill: {error}", file=sys.stderr)
        return 1
